CLASS zcl_04_table_type DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_04_TABLE_TYPE IMPLEMENTATION.
...
*    DATA addresses TYPE tt_addresses.
    DATA addresses TYPE z04t_addresses.
...
*    DATA person TYPE st_person_deep.
     DATA person TYPE z04s_person_deep.

    person-first_name = 'Thorsten'.
    person-last_name  = 'Johannsen'.
...
*    DATA persons TYPE tt_persons.
    DATA persons TYPE Z04T_PERSONS.
