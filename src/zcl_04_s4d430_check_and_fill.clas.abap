CLASS zcl_04_s4d430_check_and_fill DEFINITION PUBLIC
 FINAL
 CREATE PUBLIC.
...
CLASS ZCL_04_S4D430_CHECK_AND_FILL IMPLEMENTATION.
...
*
    CONSTANTS c_employ_table  TYPE tabname VALUE 'Z04EMPLOY'.
    CONSTANTS c_depment_table TYPE tabname VALUE 'Z04DEPMENT'.
